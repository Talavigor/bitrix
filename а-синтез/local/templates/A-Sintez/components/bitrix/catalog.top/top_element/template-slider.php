...
<div id="<? echo $strContID; ?>" class="bx_catalog_tile_home_type_2 col<? echo $arParams['LINE_ELEMENT_COUNT']; ?>">
    <div class="bx_catalog_tile_section">
        ...
        foreach ($arResult['ITEMS'] as $keyRow => $arOneRow) {
            ...
            $arRowIDs[] = $strRowID;
            ?>
            <div id="<? echo $strRowID; ?>"
                 class="bx_catalog_tile_slide <? echo($boolFirst ? 'active' : 'notactive'); ?>">
                <?
                                ...
                                <div class="bx_catalog_item_controls">
                                    ...
                                    if ($arItem['CAN_BUY']) {
                                            ...
                                            <div class="bx_catalog_item_controls_blockone">
                                                <div style="display: inline-block;position: relative;">
                                                    <a id="<? echo $arItemIDs['QUANTITY_DOWN']; ?>"
                                                       href="javascript:void(0)" class="bx_bt_white bx_small"
                                                       rel="nofollow">-</a>
                                        ...
                                        <div class="bx_catalog_item_controls_blocktwo">
                                            <a id="<? echo $arItemIDs['BUY_LINK']; ?>" class="bx_bt_white bx_medium"
...
?>
                            ...
                            ?>
                                <script type="text/javascript">
                                    var <? echo $strObName; ?> =
                                    new JCCatalogTopSlider(<? echo CUtil::PhpToJSObject($arJSParams, false, true); ?>);
                                </script>
                            <?
                            }
                            else
                                    ...
                                    if ('Y' == $arParams['USE_PRODUCT_QUANTITY']) {
                                        ...
                                        <div class="bx_catalog_item_controls_blockone">
                                            <a id="<? echo $arItemIDs['QUANTITY_DOWN']; ?>" href="javascript:void(0)"
                                               class="bx_bt_white bx_small" rel="nofollow">-</a>
                                            <input type="text" class="bx_col_input"
                                                   id="<? echo $arItemIDs['QUANTITY']; ?>"
                                                   name="<? echo $arParams["PRODUCT_QUANTITY_VARIABLE"]; ?>"
                                                   value="<? echo $arItem['CATALOG_MEASURE_RATIO']; ?>">
