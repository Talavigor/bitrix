...
<script id="basket-item-template" type="text/html">
	...
	<tr class="cart__item basket-items-list-item-container{{#SHOW_RESTORE}} basket-items-list-item-container-expend{{/SHOW_RESTORE}}"
...
<!--				<div class="basket-items-list-item-descriptions-inner" id="basket-item-height-aligner-{{ID}}">-->
					...
					{
						?>
<!--						<div class="cart__img-wr basket-item-block-image--><?//=(!isset($mobileColumns['PREVIEW_PICTURE']) ? ' hidden-xs' : '')?><!--">-->
							{{#DETAIL_PAGE_URL}}
<!--								<a href="{{DETAIL_PAGE_URL}}" class="basket-item-image-link">-->
							{{/DETAIL_PAGE_URL}}

<!--							<img class="cart__img basket-item-image" alt="{{NAME}}"-->
...
<!--						</div>-->
					...
					<div class="cart__text basket-item-block-info">
<!--						--><?//
...
//						}
//						?>
						<h3 class="cart__title basket-item-info-name">
							{{#DETAIL_PAGE_URL}}
								<a href="{{DETAIL_PAGE_URL}}" class="basket-item-info-name-link">
							{{/DETAIL_PAGE_URL}}
<? if (LANGUAGE_ID == 'en'){ ?>
    <span data-entity="basket-item-name">{{NAME_EN}}</span>
<?}else{?>
...
<!--														<div class="basket-item-property-custom-name">{{NAME}}</div>-->
														<div class="basket-item-property-custom-value"
                                                            ...
                                                            <? if (LANGUAGE_ID == 'en' && !empty('{{NAME_EN}}')){?>
                                                                {{NAME_EN}}: {{VALUE}}
                                                            <?}else{?>
															{{NAME}}: {{VALUE}}
                                            <?}?>
												...
												{{#IS_LINK}}
													<div class="basket-item-property-custom basket-item-property-custom-text
														...
														data-entity="basket-item-property">
<!--														<div class="basket-item-property-custom-name">{{NAME}}</div>-->
														<div class="cart__type basket-item-property-custom-value"
															data-column-property-code="{{CODE}}"
															data-entity="basket-item-property-column-value">
															{{#VALUE}}
        ...
        <td>
            ...
            <div class="cart__whatunit"><span>{{MEASURE_TEXT}}</span></div>
            </div>
        </td>

			<td class="basket-items-list-item-amount">
				<div class="basket__quantity basket-item-block-amount{{#NOT_AVAILABLE}} disabled{{/NOT_AVAILABLE}}"
					data-entity="basket-item-quantity-block">


					<button class="basket__minus basket-item-amount-btn-minus" data-entity="basket-item-quantity-minus">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Layer_1" x="0px" y="0px" viewBox="0 0 455 455" style="enable-background:new 0 0 455 455;" xml:space="preserve" width="17px" height="17px">
					...
					<button class="basket__plus basket-item-amount-btn-plus" data-entity="basket-item-quantity-plus">
                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" id="Capa_1" x="0px" y="0px" viewBox="0 0 42 42" style="enable-background:new 0 0 42 42;" xml:space="preserve" width="17px" height="17px">
											<polygon points="42,20 22,20 22,0 20,0 20,20 0,20 0,22 20,22 20,42 22,42 22,22 42,22 " fill="#7e7e7e"/>
										</svg>
                    </button>
