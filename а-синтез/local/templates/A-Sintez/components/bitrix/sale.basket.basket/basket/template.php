...
if (empty($arResult['ERROR_MESSAGE']))
{
	...
	?>
        ...
        <section class="pagename basket-bg">
            <h2 class="pagename__title"><?=GetMessage('BASK')?></h2>
        </section>
...
<!--                                    </div>-->
                        ...
                        <div class="cart__message">
                            <span><?=GetMessage('BASDES')?></span>
                        </div>
                        <a href="<? SITE_DIR ?>/personal/order/make/">
                        <button class="cart__checkout yellowbutton">
