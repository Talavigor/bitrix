...
else
{
	...
	<form action="<?=POST_FORM_ACTION_URI?>" method="POST" name="ORDER_FORM" id="bx-soa-order-form" enctype="multipart/form-data">
		...
		<div id="bx-soa-order" class="bx-<?=$arParams['TEMPLATE_THEME']?>" style="opacity: 0">
			<!--	MAIN BLOCK	-->
			<div class="bx-soa">
				...
				<? if ($arParams['BASKET_POSITION'] === 'before'): ?>
					<!--	BASKET ITEMS BLOCK	-->
					<div id="bx-soa-basket" data-visited="false" class="order__goods bx-soa-section bx-active">
                        <span class="order__text"><?=GetMessage('PROBAS')?></span>
						<div id="bx-order-basket" class="bx-soa-section-title-container">
							<h2 class="bx-soa-section-title col-sm-9">
						...
						<div class="cart__info bx-soa-section-content container-fluid"></div>
					</div>
...
<!--                    </div>-->
				...
				<!--	BUYER PROPS BLOCK	-->
				<div id="bx-soa-properties" data-visited="false" class="order__form bx-soa-section bx-active">
                    <span class="order__text"><?=GetMessage('DATA')?></span>
                    <div class="bx-soa-section-title-container">
						<h2 class="bx-soa-section-title col-sm-9">
				...
				<!--	ORDER SAVE BLOCK	-->
				<div id="bx-soa-orderSave"  class="order-call__button">
					<div class="checkbox">
						<?
...
<!--						--><?//=$arParams['MESS_ORDER']?>
				...
				<div style="display: none;">
					<div id='bx-soa-basket-hidden' class="order__goods bx-soa-section"></div>
