...
<div class="bx-filter <?= $templateData["TEMPLATE_CLASS"] ?> <? if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL") echo "bx-filter-horizontal" ?>">
    <div>
        ...
        <? $this->SetViewTarget("filtr_area"); ?>
        <div class="describe__filter">
            <span class="cart__values"><?= GetMessage('FILTERS_ELEM') ?></span>
            <form name="<? echo $arResult["FILTER_NAME"] . "_form" ?>" action="<? echo $arResult["FORM_ACTION"] ?>"
                ...
                <? foreach ($arResult["ITEMS"] as $key => $arItem)//prices
                {
                    ...
                    if (isset($arItem["PRICE"])):
                        ...
                        ?>
                        <div class="<?
                        if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?><? else: ?><? endif ?> bx-filter-parameters-box bx-active">
                ...
                foreach ($arResult["ITEMS"] as $key => $arItem) {
                    ...
                    ?>
                    <div class="<?
                    if ($arParams["FILTER_VIEW_MODE"] == "HORIZONTAL"):?><? else: ?><? endif ?> bx-filter-parameters-box <?
                    if ($arItem["DISPLAY_EXPANDED"] == "Y"):?>bx-active<? endif ?>">
                        <span class="bx-filter-container-modef"></span>
                        <div class="bx-filter-parameters-box-title" onclick="smartFilter.hideFilterProps(this)">
							<span class="describe__title">
                                <?
                                $arItemName = explode("@", $arItem["NAME"]);
                                        ...
                                        foreach ($arItem["VALUES"] as $val => $ar):?>
                                            <div class="radio">
                                                <label data-role="label_<?= $ar["CONTROL_ID"] ?>"
                                                       class="checkbox-text" for="<? echo $ar["CONTROL_ID"] ?>">
