...
<?=bitrix_sessid_post()?>
	<div class="mf-name">
		...
		<input type="text" name="user_name" value="<?=$arResult["AUTHOR_NAME"]?>" placeholder="<?=GetMessage('MFT_NAME')?>" class="popup-input__name popup-input">
	</div>
	...
	<div class="mf-message">
        ...
        <input name="MESSAGE" type="tel" placeholder="<?=GetMessage('MFT_PHONE')?>" value="<?=$arResult["MESSAGE"]?>" class="popup-input__phone popup-input">
	</div>
